...
<Info>
  ...
  article: [Create a WhatsApp Chatbot with Typebot](./create-whatsapp-chatbot).
  It provides a step-by-step guide on how to set up and integrate a WhatsApp
  chatbot into your real estate business.
</Info>
...
1. From the dashboard, click on the "Create a new zazubot" button to start building your real estate chatbot.
